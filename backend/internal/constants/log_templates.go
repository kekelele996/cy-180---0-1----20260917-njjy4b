...
const (
	...
	LogConsentRegister     = "consent register by=%s project=%d note=%s"
	LogConsentVerify       = "consent verify by=%s consent=%d project=%d"
	LogConsentRevoke       = "consent revoke by=%s consent=%d project=%d reason=%s"
	LogConsentBlocked      = "consent blocked project=%d action=%s status=%s"
