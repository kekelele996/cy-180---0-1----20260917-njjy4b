...
const (
	...
	LogConsentRegister  = "consent register by=%s project=%d interviewee=%s"
	LogConsentVerify    = "consent verify by=%s project=%d"
	LogConsentRevoke    = "consent revoke by=%s project=%d reason=%s"
